...
var Sent3 = "\"This is the beginning of the string" + " and this is the end of the string\""; //added purely concatenated sentence
document.write(Sent1 + Sent2 + "<br>"); //Concatenates the Sent1 and Sent2 variables. 
